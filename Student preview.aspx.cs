...
public partial class Student_preview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (c.ds.Tables["reg"].Rows.Count > 0)
        {
            ...
            string path2 = c.ds.Tables["reg"].Rows[0][11].ToString();
            Image1.ImageUrl = path2.ToString();
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (c.ds.Tables["reg"].Rows.Count > 0)
        {
            ...
            Label18.Text = c.ds.Tables["reg"].Rows[0][8].ToString();
            Label19.Text = c.ds.Tables["reg"].Rows[0][9].ToString();
            Label20.Text = c.ds.Tables["reg"].Rows[0][10].ToString();
        }
    }
    ...
    {
        c.cmd.CommandText = "select * from fees where id='" + Label1.Text + "' ";
        c.adp.Fill(c.ds, "reg");
        if (c.ds.Tables["reg"].Rows.Count > 0)
        {
            Label23.Text = c.ds.Tables["reg"].Rows[0][3].ToString();
        }
    }
}