    ...
    <table class="style5" 
        ...
        <tr>
            <td class="style6">
                ...
                CssClass="button" NavigateUrl="~/Registration/studentRegistration.aspx">Student Registration</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="style7">
                <asp:HyperLink ID="HyperLink7" runat="server" BackColor="#66FFFF" 
                    CssClass="button" NavigateUrl="~/Registration/TeachersReg.aspx">Teacher Registration</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
